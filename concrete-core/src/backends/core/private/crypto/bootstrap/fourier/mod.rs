...
use crate::backends::core::private::crypto::bootstrap::{FftBuffers, FourierBskBuffers};
    ...
    Scalar: UnsignedTorus,
{
        ...
        Scalar: UnsignedTorus,
    {
        ...
        // let rounded_input_glwe = &mut buffers.rounded_buffer;
    ...
    Scalar: UnsignedTorus,
{
    ...
    /// };
    /// use concrete_core::backends::core::private::crypto::bootstrap::{
    ///     Bootstrap, FourierBootstrapKey, FourierBskBuffers, StandardBootstrapKey,
    /// };
    ...
    ///
    /// // bootstrap
    /// let mut buffers = FourierBskBuffers::<u32>::new(polynomial_size, rlwe_dimension.to_glwe_size());
