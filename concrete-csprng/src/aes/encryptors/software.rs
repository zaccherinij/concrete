//! A module using a software implementation of `aes128-counter` random number generator.
...
pub struct Encryptor {
    // The actual software implementation of AES.
    aes: Aes128,
}
...
impl Encryptor {
    pub fn new(key: AesKey) -> Self {
        let key: [u8; 16] = key.0.to_ne_bytes();
...
mod test {
    use super::*;
    use crate::aes::encryptors::test::{CIPHERTEXT, CIPHER_KEY, PLAINTEXT};
    ...
    #[test]
    fn test_uniformity() {
        crate::aes::encryptors::test::test_uniformity::<Encryptor>(
            DevRandom::try_new(None)
