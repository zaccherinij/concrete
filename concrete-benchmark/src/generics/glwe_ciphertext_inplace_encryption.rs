...
use concrete_core::specification::engines::{
    GlweCiphertextInplaceEncryptionEngine, GlweCiphertextZeroEncryptionEngine,
...
/// A generic function benchmarking the inplace glwe encryption operation.
///
/// # Note:
///
...
>(
    ...
    Engine: GlweCiphertextInplaceEncryptionEngine<SecretKey, PlaintextVector, Ciphertext>,
    ...
    UtilRaw: RawNumeric,
{
    let mut group = c.benchmark_group(benchmark_name!(impl GlweCiphertextInplaceEncryptionEngine<
            SecretKey, 
            PlaintextVector, 
            Ciphertext
            > for Engine));
    ...
    for param in PARAMETERS {
        group.bench_with_input(
            ...
            |b, param| {
                ...
                b.iter(|| {
                    unsafe {
                        engine.inplace_encrypt_glwe_ciphertext_unchecked(
