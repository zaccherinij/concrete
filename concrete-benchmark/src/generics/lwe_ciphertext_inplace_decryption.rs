...
use concrete_core::specification::engines::{
    LweCiphertextInplaceDecryptionEngine, LweCiphertextZeroEncryptionEngine,
...
/// A generic function benchmarking the inplace lwe decryption operation.
///
/// # Note:
///
...
>(
    ...
    Engine: LweCiphertextInplaceDecryptionEngine<SecretKey, Ciphertext, Plaintext>,
    ...
    UtilRaw: RawNumeric,
{
    let mut group = c.benchmark_group(
        benchmark_name!(impl LweCiphertextInplaceDecryptionEngine<SecretKey, Ciphertext, Plaintext> for Engine),
    );
    ...
    for param in PARAMETERS {
        group.bench_with_input(
            ...
            |b, param| {
                ...
                let mut plaintext = util_engine.create_plaintext(&UtilRaw::any()).unwrap();
                ...
                b.iter(|| {
                    unsafe {
                        engine.inplace_decrypt_lwe_ciphertext_unchecked(
