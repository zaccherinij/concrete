...
use concrete_core::specification::engines::{
    GlweCiphertextVectorInplaceDecryptionEngine, GlweCiphertextVectorZeroEncryptionEngine,
...
/// A generic function benchmarking the glwe vector inplace decryption operation.
///
/// # Note:
///
    ...
    UtilRaw: RawNumeric,
{
    let mut group = c.benchmark_group(
        benchmark_name!(impl GlweCiphertextVectorInplaceDecryptionEngine<
            SecretKey, 
            CiphertextVector,
            PlaintextVector
            > for Engine),
    ...
    for param in PARAMETERS {
        group.bench_with_input(
            ...
            |b, param| {
                ...
                b.iter(|| {
                    unsafe {
                        engine.inplace_decrypt_glwe_ciphertext_vector_unchecked(
