...
/// A generic function benchmarking the glwe vector inplace encryption operation.
///
/// # Note:
///
    ...
    UtilRaw: RawNumeric,
{
    let mut group = c.benchmark_group(
        benchmark_name!(impl GlweCiphertextVectorInplaceEncryptionEngine<
            SecretKey,
            PlaintextVector,
            CiphertextVector
            > for Engine),
    ...
    for param in PARAMETERS {
        group.bench_with_input(
            ...
            |b, param| {
                ...
                b.iter(|| {
                    unsafe {
                        engine.inplace_encrypt_glwe_ciphertext_vector_unchecked(
