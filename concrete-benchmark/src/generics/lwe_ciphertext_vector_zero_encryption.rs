...
use concrete_core::specification::engines::{
    LweCiphertextVectorZeroEncryptionEngine, LweSecretKeyGenerationEngine,
};

use concrete_core::specification::entities::{LweCiphertextVectorEntity, LweSecretKeyEntity};
    ...
    for param in PARAMETERS {
        group.bench_with_input(
            ...
            |b, param| {
                ...
                b.iter(|| {
                    unsafe {
                        black_box(engine.zero_encrypt_lwe_ciphertext_vector_unchecked(
